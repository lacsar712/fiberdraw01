...
import (
	...
	"example.com/fiberdraw/internal/backup"
	"example.com/fiberdraw/internal/model"
	"example.com/fiberdraw/internal/policy"
	"example.com/fiberdraw/internal/report"
	"example.com/fiberdraw/internal/validate"
	"example.com/fiberdraw/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=fiberdraw.zip")
	_, _ = w.Write(b)
}
