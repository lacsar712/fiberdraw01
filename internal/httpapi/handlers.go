...
import (
	...
	"example.com/fiberdraw/internal/search"
	"example.com/fiberdraw/internal/textfmt"
)
...
func (s *Server) handleHealth(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, 200, map[string]any{"status": "ok", "records": n, "app": "FiberDraw Tower"})
}

func (s *Server) handleMeta(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, 200, map[string]any{
		"title":  "FiberDraw Tower",
